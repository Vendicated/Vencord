...
export declare class ReadStateStore extends Store {
    ...
    ackMessageId(id: string, type?: ReadStateType /* = ReadStateType.CHANNEL */): string | null;
    getAllReadStates<ForCache extends boolean>(forCache: ForCache): SerializedReadState<ForCache>;
    getForDebugging(channelId: string, type?: ChannelIdReadStateType): ReadState<ChannelIdReadStateType> | undefined;
    ...
    getMentionCount(id: string, type?: ReadStateType /* = ReadStateType.CHANNEL */): number;
    ...
    getOldestUnreadMessageId(id: string, type?: ReadStateType /* = ReadStateType.CHANNEL */): string | null;
    getOldestUnreadTimestamp(id: string, type?: ReadStateType /* = ReadStateType.CHANNEL */): number;
    ...
    getTrackedAckMessageId(id: string, type?: ReadStateType /* = ReadStateType.CHANNEL */): string | null;
    getUnreadCount(id: string, type?: ReadStateType /* = ReadStateType.CHANNEL */): number;
    hasOpenedThread(id: string, type?: ReadStateType /* = ReadStateType.CHANNEL */): boolean;
    hasRecentlyVisitedAndRead(id: string, type?: ReadStateType /* = ReadStateType.CHANNEL */): boolean;
    hasTrackedUnread(id: string, type?: ReadStateType /* = ReadStateType.CHANNEL */): boolean;
    hasUnread(id: string, type?: ReadStateType /* = ReadStateType.CHANNEL */): boolean;
    hasUnreadOrMentions(id: string, type?: ReadStateType /* = ReadStateType.CHANNEL */): boolean;
    hasUnreadPins(channelId: string): boolean;
    initialize(): void;
    isEstimated(id: string, type?: ReadStateType /* = ReadStateType.CHANNEL */): boolean;
    isForumPostUnread(id: string, type?: ReadStateType /* = ReadStateType.CHANNEL */): boolean;
    isNewForumThread(forumThreadId: string, forumId: string, guild?: GuildRecord | null): boolean;
    /**
     ...
     */
    lastMessageId(id: string, type?: ReadStateType /* = ReadStateType.CHANNEL */): string | null;
    /**
     ...
     */
    lastMessageTimestamp(id: string, type?: ReadStateType /* = ReadStateType.CHANNEL */): number;
    /**
