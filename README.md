...
-   100+ plugins built in: [See a list](https://vencord.dev/plugins)
    -   Some highlights: SpotifyControls, MessageLogger, Experiments, GameActivityToggle, Translate, NoTrack, QuickReply, Free Emojis/Stickers, PermissionsViewer, CustomCommands, ShowHiddenChannels, PronounDB
