...
export function getCurrentVoice(voices = window.speechSynthesis?.getVoices()) {
    ...
    if (settings.store.voice) {
        ...
        new Logger("VcLoggerAndTracking").error(`Voice "${settings.store.voice}" not found. Resetting to default.`);
    }
...
export const settings = definePluginSettings({
    ...
    enableSounds: {
        description: "Enable Sounds Navigating Voice Channels",
        type: OptionType.BOOLEAN,
        default: false
    },
    enableLogging: {
        description: "Enable Logging Navigating Voice Channels",
        type: OptionType.BOOLEAN,
        default: true
    },
    logInCurrentVoiceChannel: {
        description: "Add logs only in the current voice channel",
        type: OptionType.BOOLEAN,
        default: true
    },
    sayOwnName: {
