...
export const Card = waitForComponent<t.Card>("Card", {
    deps: [filters.byProps("cardPrimary", "cardPrimaryOutline")],
    factory: CardClasses => m => m.Types?.PRIMARY === CardClasses.cardPrimary,
});
