...
export type ProfileCollectionFactory = Function;

export interface ProfileCollectionData {
    /** Function that renders the collection component, receives the full profile props */
    render: ProfileCollectionFactory;
    /** Higher priority collections appear first in the list. Default: 0 */
    priority?: number;
}
