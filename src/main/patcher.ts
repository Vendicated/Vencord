...
console.log("[Tallycord] Starting up...");
...
if (!IS_VANILLA) {
    ...
    class BrowserWindow extends electron.BrowserWindow {
        constructor(options: BrowserWindowConstructorOptions) {
            if (options?.webPreferences?.preload && options.title) {
                ...
                options.webPreferences.preload = join(__dirname, IS_DISCORD_DESKTOP ? "preload.js" : "tallycordDesktopPreload.js");
    ...
    process.env.DATA_DIR = join(app.getPath("userData"), "..", "Tallycord");
    ...
    console.log("[Tallycord] Running in vanilla mode. Not loading Tallycord");
}

console.log("[Tallycord] Loading original Discord app.asar");
