        ...
        // },
        {
            ...
            replacement: [
                ...
                },
                {
                    ...
                    match: /(\.CLOUD_GAMING_ACTIVITY.{0,500})(\i.\i.\i\(\i.\i#{intl::QUEST_ACCEPTED}\))/,
                    replace: "$1$self.getQuestAcceptedButtonText(arguments[0].quest)??$2,onClick:()=>{$self.processQuestForAutoComplete(arguments[0].quest)}"
                }
            ]
        },
        {
