...
const BadgeSettings = () => {
    const [images, setImages] = useState([
        { src: "https://github.com/Equicord/Equibored/raw/main/misc/donor.png", shown: settings.store.showEquicordDonor, title: "Equicord donor badges", key: "EquicordDonor", position: settings.store.EquicordDonorPosition },
