...
const BadgeSettings = () => {
    const [images, setImages] = useState([
        ...
        { src: "https://cdn.discordapp.com/badge-icons/bf01d1073931f921909045f3a39fd264.png", shown: settings.store.showDiscordProfile, title: "Discord profile badges (HypeSquad, Discord Staff, Orbs Apprentice, etc.)", key: "DiscordProfile", position: settings.store.DiscordProfilePosition },
