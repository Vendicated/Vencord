...
const BadgeSettings = () => {
    const [images, setImages] = useState([
        { src: "https://images.equicord.org/api/v1/files/raw/0199d5dd-7ee3-7000-8ea5-ef331a206cee", shown: settings.store.showEquicordDonor, title: "Equicord donor badges", key: "EquicordDonor", position: settings.store.EquicordDonorPosition },
