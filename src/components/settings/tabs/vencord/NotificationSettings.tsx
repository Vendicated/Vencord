...
export function NotificationSection() {
    return (
        <section className={Margins.top16}>
            <Heading tag="h5">Notifications</Heading>
        ...
        <div style={{ padding: "1em 0" }}>
            ...
            {settings.useNative !== "never" && Notification?.permission === "denied" && (
                <ErrorCard style={{ padding: "1em" }} className={Margins.bottom8}>
                    <Heading tag="h5">Desktop Notification Permission denied</Heading>
            ...
            <Heading tag="h5" className={Margins.top16 + " " + Margins.bottom8}>Notification Position</Heading>
            <Select
            ...
            <Heading tag="h5" className={Margins.top16 + " " + Margins.bottom8}>Notification Timeout</Heading>
            ...
            <Heading tag="h5" className={Margins.top16 + " " + Margins.bottom8}>Notification Log Limit</Heading>
