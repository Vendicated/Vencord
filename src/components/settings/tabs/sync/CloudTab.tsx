        ...
        <SettingsTab title="Equicord Cloud">
            <Forms.FormSection title="Cloud Settings" className={Margins.top16}>
                <Forms.FormText variant="text-md/normal" className={Margins.bottom20}>
                    ...
                    <br />
                    We use our own Equicloud <Link href="https://github.com/Equicord/Equicloud">source code</Link> to provide our cloud instance which has a 60MB backup cap.
                    <br />
                    ...
                    <br />
                    The Equicloud repository is open source so you can host it yourself it you would like.
                    <br />
