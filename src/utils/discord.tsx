...
export function openPrivateChannel(recipientIds: string | string[], joinCall?: boolean, joinCallVideo?: boolean) {
    ChannelActionCreators.openPrivateChannel({ recipientIds, joinCall, joinCallVideo });
}
