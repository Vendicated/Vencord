...
function colorToHex(color: string) {
  ...
  if (!ctx) return "#000000"; // no GPU, you'll have bigger issues than a misscolored title bar
  ctx.fillStyle = color;
  ctx.fillRect(0, 0, 1, 1);
  return "#" + [...ctx.getImageData(0, 0, 1, 1).data.slice(0, 3), n => n.toString(16).padStart(2, "0")].join("");
}
