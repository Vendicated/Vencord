...
const OPEN_URL = "Bencord.Plugins.plugins.ViewIcons.openImage(";
export default definePlugin({
    ...
    openImage(url: string) {
        BencordNative.ipc.invoke(IpcEvents.OPEN_EXTERNAL, url);
        // husk
        /* openModal(() => (
            <ImageModal
                shouldAnimate={true}
            ...
            replacement: [
                ...
                },
                {
                    ...
                    replace: (_, menu, createElement, menuGroup, copyIdElement) =>
                        ...
                        `{id:"viewicons-copy-banner",label:"View Banner",action:()=>${OPEN_URL}Bencord.Webpack.findByProps("getGuildBannerURL").getGuildBannerURL(_guild).replace(/\\?size=.+/, "?size=2048"))})`
                        + `,${copyIdElement}])`
                }
            ]
        }
