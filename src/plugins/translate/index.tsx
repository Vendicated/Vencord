...
export default definePlugin({
    name: "Translate",
    description: "Translate your and others' messages with Google Translate or DeepL. Press on the translation button in the message bar to customize the languages or enable auto translation.",
