...
export default definePlugin({
    ...
    start() {
        if (settings.store.removeGift) {
            ...
            styleGift.textContent = "button[aria-label='Send a gift'] { display: none; }";
        ...
        if (settings.store.removeGif) {
            ...
            styleGif.textContent = "button[aria-label='Open GIF picker'] { display: none; }";
        ...
        if (settings.store.removeSticker) {
            ...
            styleSticker.textContent = "button[aria-label='Open sticker picker'] { display: none; }";
        ...
        if (settings.store.removeEmoji) {
            ...
            styleEmoji.textContent = "button[aria-label='Select emoji'] { display: none; }";
