...
import { Button, ChannelStore, Forms, GuildMemberStore, SelectedChannelStore, SelectedGuildStore, SessionsStore, useMemo, UserStore, VoiceStateStore } from "@webpack/common";
    ...
    flux: {
        VOICE_STATE_UPDATES({ voiceStates }: { voiceStates: VoiceStateChangeEvent[]; }) {
            ...
            for (const state of voiceStates) {
                ...
                if (isMe && state.sessionId !== SessionsStore.getSession().sessionId) continue;
                if (!isMe) {
