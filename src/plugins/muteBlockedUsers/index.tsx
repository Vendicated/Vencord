...
export default definePlugin({
    ...
    description: `Automatically mute(voice) blocked users for better visibility and manageability in your Discord experience. Transform normal blocks into "real" ones with ease, ensuring a smoother and more organized communication environment.`,
