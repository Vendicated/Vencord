...
const INSANE_REGEX = /(#(?:[a-f0-9]{3,4}|[a-f0-9]{6}|[a-f0-9]{8})\b|rgb\(\s*(?:[01]?\d\d?|2[0-4]\d|25[0-5])\s*(?:,|\s)\s*(?:[01]?\d\d?|2[0-4]\d|25[0-5])\s*(?:,|\s)\s*(?:[01]?\d\d?|2[0-4]\d|25[0-5])\s*\)|rgb\(\s*(?:[0-9]?\d|100)%\s*(?:,|\s)\s*(?:[0-9]?\d|100)%\s*(?:,|\s)\s*(?:[0-9]?\d|100)%\s*\)|rgba\(\s*(?:[01]?\d\d?|2[0-4]\d|25[0-5])\s*,\s*(?:[01]?\d\d?|2[0-4]\d|25[0-5])\s*,\s*(?:[01]?\d\d?|2[0-4]\d|25[0-5])\s*,\s*(?:(?:1|0?\.\d+)|(?:[0-9]?\d|100)%)\s*\)|rgb\(\s*(?:[0-9]?\d|100)%\s*(?:[0-9]?\d|100)%\s*(?:[0-9]?\d|100)%\s*(?:\/\s*(?:(?:1|0?\.\d+)|(?:[0-9]?\d|100)%)\s*)?\)|rgb\(\s*(?:[01]?\d\d?|2[0-4]\d|25[0-5])\s*(?:[01]?\d\d?|2[0-4]\d|25[0-5])\s*(?:[01]?\d\d?|2[0-4]\d|25[0-5])\s*\/\s*(?:(?:1|0?\.\d+)|(?:[0-9]?\d|100)%)\s*\)|hsl\(\s*(?:[012]?\d\d?|3[0-5]\d|360)(?:deg)?\s*(?:,|\s)\s*(?:[0-9]?\d|100)%\s*(?:,|\s)\s*(?:[0-9]?\d|100)%\s*\)|hsla\(\s*(?:[012]?\d\d?|3[0-5]\d|360)(?:deg)?\s*,\s*(?:[0-9]?\d|100)%\s*,\s*(?:[0-9]?\d|100)%\s*,\s*(?:(?:1|0?\.\d+)|(?:[0-9]?\d|100)%)\s*\)|hsl\(\s*(?:[012]?\d\d?|3[0-5]\d|360)(?:deg)?\s*(?:[0-9]?\d|100)%\s*(?:[0-9]?\d|100)%\s*\/\s*(?:(?:1|0?\.\d+)|(?:[0-9]?\d|100)%)\s*\))/ig;
