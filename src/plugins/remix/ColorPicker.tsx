...
// This entire file is stolen from https://github.com/Vendicated/Vencord/pull/1700/
// Will remove once it's merged
...
// @ts-ignore shut up vscode it works
...
export function ColorPicker(props: ColorPickerProps & { width: number; height: number; }) {
