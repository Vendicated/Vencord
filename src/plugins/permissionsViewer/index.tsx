...
export default definePlugin({
    ...
    channelContextMenuPatch: makeContextMenuPatch("mark-channel-read", MenuItemParentType.Channel),
    guildContextMenuPatch: makeContextMenuPatch("mark-guild-read", MenuItemParentType.Guild),
