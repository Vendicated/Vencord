        ...
        <Tooltip text="Toggle Game Activity">
            {tooltipProps => (
                <button
                    ...
                    onClick={() => ShowCurrentGame?.updateSetting(!ShowCurrentGame.getSetting())}
                >
                    <svg
                        width="24"
                        height="24"
                    ...
                    >
                        <g fill="currentColor">
                            ...
                            {!ShowCurrentGame?.getSetting() && <line x1="920" y1="280" x2="40" y2="880" stroke="var(--status-danger)" stroke-width="80" />}
                        </g>
                    </svg>
                </button>
            )}
