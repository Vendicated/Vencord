...
import { UserSettings } from "@webpack/common";
        ...
        return (
            <svg width="20" height="20" viewBox="0 0 24 24">
                <path
                    ...
                    mask={!showCurrentGame ? "url(#gameActivityMask)" : undefined}
...
function GameActivityToggleButton() {
    const showCurrentGame = UserSettings.ShowCurrentGame!.useSetting();
    ...
    return (
        <Button
            ...
            onClick={() => { UserSettings.ShowCurrentGame!.updateSetting((old: any) => !old); }}
        />
    );
}
