...
import "./CustomVoiceChannelSection.css";
...
const cl = classNameFactory("vc-uvs-custom");
...
export const CustomVoiceChannelSection = ({ channel, showHeader, joinDisabled }: VoiceChannelFieldProps) => {
