...
const UsersList = LazyComponent(() => findByCode("defaultRenderUser", "showDefaultAvatarsForNullUsers"));
...
function VoiceActivityIcon({ user, needContainer, inProfile }: VoiceActivityIconProps) {
    ...
    const canConnectToChannel = PermissionStore.can(Permissions.CONNECT, channel);
...
export default VoiceActivityIcon;
