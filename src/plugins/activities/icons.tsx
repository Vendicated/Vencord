...
export const ControllerIcon: React.FC<IconProps> = ({ width, height, color }) => {
    // Don't ask why I did it this way, this is exactly how discord does it, so I did as well.
    return <svg width={width} height={height} viewBox="0 0 48 48" style={{ paddingInline: "1px" }}>
