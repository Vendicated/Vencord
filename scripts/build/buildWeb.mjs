...
const commonOptions = {
    ...commonOpts,
    entryPoints: ["browser/Tallycord.ts"],
    format: "iife",
...
const buildConfigs = [
    ...
    },
    {
        ...
        footer: { js: "//# sourceURL=TallycordWeb" },
    },
    {
        ...commonOptions,
    ...
    },
    {
        ...
        outfile: "dist/Tallycord.user.js",
        banner: {
        ...
        footer: {
            // UserScripts get wrapped in an iife, so define Tallycord prop on window that returns our local
            js: "Object.defineProperty(unsafeWindow,'Tallycord',{get:()=>Tallycord});",
        },
    },
];
...
async function buildExtension(target, files) {
    const entries = {
        "dist/Tallycord.js": await readFile("dist/extension.js"),
        "dist/Tallycord.css": await readFile("dist/extension.css"),
...
const appendCssRuntime = readFile("dist/Tallycord.user.css", "utf-8").then(
    (content) => {
        const cssRuntime = `
...
`;
        ...
        return appendFile("dist/Tallycord.user.js", cssRuntime);
    }
);
