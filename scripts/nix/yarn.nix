{ fetchurl, fetchgit, linkFarm, runCommand, gnutar }: rec {
  ...
  packages = [
    ...
    {
      name = "_types_react___react_17.0.2.tgz";
      path = fetchurl {
        name = "_types_react___react_17.0.2.tgz";
        url  = "https://registry.yarnpkg.com/@types/react/-/react-17.0.2.tgz";
    ...
    {
      name = "_types_yazl___yazl_2.4.2.tgz";
      path = fetchurl {
        name = "_types_yazl___yazl_2.4.2.tgz";
        url  = "https://registry.yarnpkg.com/@types/yazl/-/yazl-2.4.2.tgz";
        sha512 = "T+9JH8O2guEjXNxqmybzQ92mJUh2oCwDDMSSimZSe1P+pceZiFROZLYmcbqkzV5EUwz6VwcKXCO2S2yUpra6XQ==";
      };
    }
    {
    ...
    {
      name = "console_menu___console_menu_0.1.0.tgz";
      path = fetchurl {
        name = "console_menu___console_menu_0.1.0.tgz";
        url  = "https://registry.yarnpkg.com/console-menu/-/console-menu-0.1.0.tgz";
        sha512 = "gOGvuhugXvHggnodbEop0Wzh05eondeCdpPZqcwlzJc7KoPrdsHUM8TZug1lN2jN7Qm3XrZcoP5dZDaO2CaYSw==";
      };
    }
    {
    ...
    {
      name = "discord_types___discord_types_1.3.26.tgz";
      path = fetchurl {
        name = "discord_types___discord_types_1.3.26.tgz";
        url  = "https://registry.yarnpkg.com/discord-types/-/discord-types-1.3.26.tgz";
        sha512 = "ToG51AOCH+JTQf7b+8vuYQe5Iqwz7nZ7StpECAZ/VZcI1ZhQk13pvt9KkRTfRv1xNvwJ2qib4e3+RifQlo8VPQ==";
      };
    }
    {
    ...
    {
      name = "standalone_electron_types___standalone_electron_types_1.0.0.tgz";
      path = fetchurl {
        name = "standalone_electron_types___standalone_electron_types_1.0.0.tgz";
        url  = "https://registry.yarnpkg.com/standalone-electron-types/-/standalone-electron-types-1.0.0.tgz";
        sha512 = "0HOi/tlTz3mjWhsAz4uRbpQcHMZ+ifj1JzWW9nugykOHClBBG77ps8QinrzX1eow4Iw2pnC+RFaSYRgufF4BOg==";
      };
    }
    {
